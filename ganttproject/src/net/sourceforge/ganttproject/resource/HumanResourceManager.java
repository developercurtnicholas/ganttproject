...
import net.sourceforge.ganttproject.ourAddIns.PictureData;
import net.sourceforge.ganttproject.ourAddIns.ProfilePicture;
...
public class HumanResourceManager {
  ...
  private void fireResourceAdded(HumanResource resource) {
    ...
    System.out.println("fireResourcesAdded");
  }
  ...
  void fireResourceChanged(HumanResource resource) {
    ...
    System.out.println("fireResourcesChanged");
  }
  ...
  private void fireResourcesRemoved(HumanResource[] resources) {
    ...
    System.out.println("fireResourcesRemoved");
  }
